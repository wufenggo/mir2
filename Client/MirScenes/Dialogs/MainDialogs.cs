...
namespace Client.MirScenes.Dialogs
{
    ...
    public class ItemSkillBean
    {
        ...
        public static void init()
        {
            ...
            {
                list.Add(new ItemSkillBean(ItemSkill.Warrior1, "破山阵", "普通攻击几率破防", RequiredClass.战士, 30));
                ...
                list.Add(new ItemSkillBean(ItemSkill.Wizard1, "迷惑阵", "强化诱惑之光，诱惑宝宝成功率提升", RequiredClass.法师, 30));
                ...
                list.Add(new ItemSkillBean(ItemSkill.Taoist1, "符咒阵", "感悟火符真谛使得火符威力增加", RequiredClass.道士, 30));
                ...
                list.Add(new ItemSkillBean(ItemSkill.Assassin1, "月隐阵", "几率增加隐身时间", RequiredClass.刺客, 30));
                ...
                list.Add(new ItemSkillBean(ItemSkill.Archer1, "气流阵", "气流术恢复气速度增加", RequiredClass.弓箭手, 30));
